#####################################################################################
# Mask-based_CNN_3CL:
# Test the Mask-based CNN model trained by 3CL for speech enhancement,
...
#       test_n_tilde_3CL.mat
#       test_s_tilde_3CL.mat
#       test_s_hat_3CL.mat
#
# Important Note: 
#
...
model.load_weights('./training_results/mask_CNN_3CL' + '.h5')
...
recon_n_tilde = './test_results/test_n_tilde_3CL.mat'
recon_n_tilde = os.path.normcase(recon_n_tilde)
sio.savemat(recon_n_tilde, {'test_n_tilde':n_tilde})

recon_s_tilde = './test_results/test_s_tilde_3CL.mat'
...
#####################################################################################
[s_hat2,useless,s_hat1] = model.predict([test_noisy,test_noisy_speech,test_noisy_speech]) # all the three outputs are the same
print('     s_hat shape: %s' % str(s_hat2.shape))
recon_s_hat = './test_results/test_s_hat_3CL.mat'
